...
export function PayoutsList() {
  ...
  // Combine payouts data with affiliate info
  ...
  const handleProcessPayout = async (id: string) => {
    try {
      ...
      toast({
        title: "Error",
        description: `Failed to process payout: ${error instanceof Error ? error.message : "Unknown error"}`,
        variant: "destructive",
      })
    }
  }
