...
async function seedDatabase(clearExisting = true) {
  ...
  const settings = await Settings.create({
    ...
    apiKeys: {
      paymanApiKey: "YWd0LTFmMDBhNTJiLTQyYzgtNjg1MS05Y2UzLWZmN2NhN2M0ODI5MjpYZ0lXRE9LbDZMbE1Bbk5JdzFqb3pTdmh2SQ==",
    },
    commissionDefaults: {
      defaultRate: 10,
  ...
  const affiliates = await Affiliate.create([
    ...
    },
    {
      ...
      paymentDetails: {
        name:"TESTING-AGAIN",
        payeeId: "pd-2f00acb2-fba4-6983-b0fd-d7b9ea207570",
        contactDetails: {
    ...
    },
    {
      ...
      paymentDetails: {
        name:"TESTING-AGAIN",
        payeeId: "pd-3f00acb2-fba4-6983-b0fd-d7b9ea207571",
        contactDetails: {
          email: "bob@example.com",
